...
- Continue Phase 6 by deciding whether this governance workflow should surface as a single operator-facing entry point beyond the existing component-level APIs and tests.
