...
- Continue the Phase 11 rollout by introducing bounded specialist-to-specialist message handling on top of the deterministic session scheduler while keeping transcript observability and MCP payload stability intact.
