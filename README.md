...
- Continue Phase 6 by deciding whether this governance workflow and release bundle should surface as a single operator-facing entry point beyond the existing component-level APIs and tests.
